...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (doom-themes which-key use-package rainbow-delimiters projectile neotree magit ivy hl-todo git-gutter gcmh format-all dashboard crux company-quickhelp centered-window)))
 '(tramp-backup-directory-alist (quote (("." . "~/.emacs.d/backups/"))) t))
(custom-set-faces
